...
dp = 0.07; % division probability
xp_vals = linspace(1e-5,2e-4,20); % death probability
...
tmax = 500;
dt = 0.001;
total_cells = zeros(1, length(xp_vals));
p=1;
for xp = xp_vals
    c=1;
...
plot(xp_vals, total_cells,'-o')
hold on
ylim([50 75])
ylabel('Equilibrium cell numbers N')
xlabel('death probability d')
legend("N0: " + N0 + ", b: 0.03, k: 4, dt: " + dt, ... 
      "N0: " + N0 + ", b: 0.03, k: 10, dt: " + dt, ...
      "N0: " + N0 + ", b: 0.07, k: 4, dt: " + dt, ... 
      "N0: " + N0 + ", b: 0.07, k: 10, dt: " + dt)
grid on
grid minor
